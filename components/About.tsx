        ...
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="order-2 flex min-w-0 flex-col lg:order-1 lg:col-span-6">
            <div className="mx-auto w-full max-w-xl text-center lg:mx-0 lg:max-w-none lg:text-left">
              ...
              <div className="mt-8 space-y-5 text-pretty text-base leading-relaxed text-slate-600 sm:text-lg sm:leading-8 max-md:text-justify max-md:hyphens-auto md:hyphens-none lg:max-w-[42rem]">
                {(() => {
                  ...
                  return paras.map((para, i) => (
                    <p
                      ...
                      className={`break-words [text-wrap:pretty] ${
                        i === 0
                          ? 'first-letter:font-semibold first-letter:text-emerald-800 first-letter:text-[1.35em] first-letter:leading-none'
                          : ''
                      }`}
                    >
                      {para}
