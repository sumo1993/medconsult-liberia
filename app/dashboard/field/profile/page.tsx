...
import { ArrowLeft, Camera, Save, User, GraduationCap, Briefcase, Lock } from 'lucide-react';
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mt-6">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            Census field accounts are managed by your administrator. You cannot change your password or delete your
            account from this screen. If you are locked out or need a new password, contact your program admin.
          </p>
        </div>
      </main>
    </div>
