...
import { ArrowLeft, Mail, Clock, Reply, Send, MessageCircle, CheckCircle, XCircle } from 'lucide-react';
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">View and respond to patient inquiries</p>
              </div>
            </div>
            <button
              onClick={() => router.push('/dashboard/management')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 bg-white rounded-lg shadow">
            <div className="p-4 border-b bg-emerald-50">
              <h2 className="font-semibold text-emerald-900">Inbox ({messages.length})</h2>
            </div>
            ...
            {selectedMessage ? (
              <div className="p-6">
                ...
                <div className="border-t pt-4">
                  <h3 className="text-sm font-semibold text-gray-700 mb-3">Reply in App</h3>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <Reply size={16} />
                        <span className="text-sm">Or Reply via Email</span>
                      </button>
                      <button
