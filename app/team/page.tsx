          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {loading ? (
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {members.filter(member => member.role !== 'System Administrator').map((member) => (
                  <div key={member.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-emerald-600 font-semibold mb-2 text-center">{member.role}</p>
                      ...
                      {member.bio && (
                        <p className="text-gray-700 mb-4 leading-relaxed text-center mx-auto">
                          {member.bio}
                        </p>
                      )}
